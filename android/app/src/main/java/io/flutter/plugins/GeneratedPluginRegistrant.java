...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.ajinkya.app_badger.AppBadgerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin app_badger, com.ajinkya.app_badger.AppBadgerPlugin", e);
    }
    try {
